...
$find_my_products = Functions::getResolvedRequests();
if($find_my_products){
...
<div class='f'><h5>Price: {$currency}".number_format($product['price'], 2, '.', ',')."</h5> </div>
                            ...
                            <div class='b'>
                                <div class='f m-t-10'> <a class='text-primary' href='".Functions::getPageUrl("/backend")."/single_item/{$product['id']}/huioh43940-80'>View on Website</a> </div>
                            </div>
                        </div>
                ...
                <div class='col-lg-3 lstDscp'>
                    ...
                    <h3 class='m-b-0'><span class='badge badge-warning myAprv'><i class='fa fa-check'></i>BOUGHT</span></h3>
                    <div class='row lstBtnWrp'>
                        <div class='lstEdtBtn mr-2'>
                            <a class='btn btn-default btn-rounded' href='".Functions::getPageUrl("/backend")."/edit-item/{$product['id']}/rsano3/listing/gs_l=16d'><i class='fa fa-edit'></i> Edit</a>
                        </div>
                        <div class='lstdltBtn'>
                            <a class='btn btn-danger btn-flat btn-addon btn-xs' href='".Functions::getPageUrl("/backend")."/private/delete-product/{$product['id']}/rsano3/listing/gs_l=16'><i class='fa fa-close'></i> Delete</a>
                        </div>
                    </div>
