                    ...
                    <div class='panel-group panel-group-simple panel-group-continuous' id='accordion2' aria-multiselectable='true' role='tablist'>
                      ...
                      <div class='panel'>
                        <div class='panel-collapse collapse show' id='answer-1' aria-labelledby='question-1' role='tabpanel'>
                          <div class='panel-body'>
                            <p>
                              This Privacy Policy explains what personal data is collected when you  use the Vensle.com website or any Vensle.com mobile application and the  services provided through it. </p>
                            <p>By Using the Service, You Promise Us That </p>
                            <ol>
                            ...
                            <p>If you do not agree or are unable to  make this promise, you must not use the Service. In such case, you must contact  the support team via online chat or email to (a) request deletion of your  account and data.</p>
                            <p>Vensle Ltd. is a registered company with the British government. Vensle  Inc. will be responsible for storing your personal data&rsquo;s provided by you on  this website.<br>
                              We collect data you give us voluntarily (for example, an email address).  We also collect data automatically (for example, your IP address).</p>
                            <h5>
                              <li>Data you give us</li>
                            </h5>
                            <p>You may be asked to provide us  information about yourself when you register for and/or use the Service. This  information includes: first name, phone number, email (together &ldquo;Required  Information&rdquo;), last name, photo, address details, working hours.<br>
                              To use our Service and register an  account, you will need to provide Required Information. You will be able to use  the Service even if you do not give this data to us, but some Service&rsquo;s  functionality may be limited to you (for example, if you do no register an  account, you will not be able to chat with other users, sell items, place a  request etc. <br>
                              Sometimes you may also need to  provide to us additional information in the communication with our Support Team  in order to fulfil your request (for example, if your account was previously  blocked, we may ask you to confirm your identity by providing an ID document).</p>
                            <h5>
                              <li>Data provided to us by third parties</li>
                            </h5>
                            <p>When you decide to log in using Facebook or Google, we get personal data  from your Facebook or Google account. This includes your profile image, name,  and Facebook ID, Google ID, friends list. For more information, please refer to  the Facebook Permissions Reference (describes the categories of information,  which Facebook may share with third parties and the set of requirements) and to  the Facebook Data policy. In addition, Facebook lets you control the choices  you made when connecting your Facebook profile to the App on their Apps and  Websites page. To know more about how Google processes your data, visit its  Privacy Policy.</p>
                            <h5>
                              <li>Data we collect automatically:</li>
                            </h5>  
							  <ol>
                            ...
                            <ol>
                              <li>To provide our Service<p>This includes enabling you to use the Service in a seamless manner and preventing  or addressing Service errors or technical issues.</p></li>
							
                              <li>To customize your experience<p>We process your personal data to adjust the content of the Service and  make offers tailored to your personal preferences and interests.</p></li>
                            
                              <li>To manage your account and provide  you with customer support<p>We process your personal data to respond to your requests for technical  support, Service information or to any other communication you initiate. This  includes accessing your account to address technical support requests. For this  purpose, we may send you, for example, notifications or emails about the  performance of our Service, security, payment transactions, notices regarding  our Terms and Conditions of Use or this Privacy Policy.</p></li>
                            
                              <li>To communicate with you regarding  your use of our Service<p>We communicate with you, for example,  by push notifications or in the chat. As a result, you may, for example,  receive a notification whether on the Website or via email that you received a  new message on Vensle. To opt out of receiving push notifications, you need to  change the settings on your browser or mobile device. To opt out of the certain  type of emails, you need to follow an unsubscribe link located in the footer of  the email by contacting our support team at contact@vensle.com or in your  profile setting.</p><p>
                              The services that we use for these  purposes may collect data concerning the date and time when the message was  viewed by our users, as well as when they interacted with it, such as by  clicking on links included in the message.</p></li>
                            
                            
                              <li>To research and analyze your use of  the Service<p>This helps us to better understand our business, analyze our operations,  maintain, improve, innovate, plan, design, and develop Vensle and our new  products. We also use such data for statistical analysis purposes, to test and  improve our offers. This enables us to better understand what features and  sections of Vensle our users like more, what categories of users use our  Service. As a consequence, we often decide how to improve Vensle based on the  results obtained from this processing. For example, if we discover that Jobs  section is not as popular as others, we may focus on improving it.</p></li>
                            
                              <li>To send you marketing communications<p>We process your personal data for our  marketing campaigns. We may add your email address to our marketing list. As a  result, you will receive information about our products, such as for example,  special offers, and products of our partners. If you do not want to receive  marketing emails from us, you can unsubscribe following instructions in the footer  of the marketing emails, by contacting our support team at support@Vensle.com  or in your profile setting.</p><p>
                              We may also show you advertisements  on the Website, and send you push notifications for marketing purposes. To opt  out of receiving push notifications, you need to change the settings on your  device or/and browser.</p></li>
                            
                              <li>To personalize our ads<p>We and our partners use your personal  data to tailor ads and possibly even show them to you at the relevant time. For  example, if you have visited our Website, you might see ads of our products,  for example, in your Facebook&rsquo;s feed.</p><p>
                              ...
                              Browsers:</p><p>
                              It is also may be possible to stop  your browser from accepting cookies altogether by changing your browser&rsquo;s  cookie settings. You can usually find these settings in the &ldquo;options&rdquo; or  &ldquo;preferences&rdquo; menu of your browser. The following links may be helpful, or you  can use the &ldquo;Help&rdquo; option in your browser.</p>
							  <ol>
                            ...
                            <p><strong>Google&nbsp;</strong>allows its users to&nbsp;<u><a href='https://adssettings.google.com/authenticated?hl=ru'>opt out of Google&rsquo;s personalized ads</a></u>&nbsp;and to&nbsp;<u><a href='https://tools.google.com/dlpage/gaoptout/'>prevent  their data from being used by Google Analytics.</a></u> <br>
                              <strong>Facebook&nbsp;</strong>also allows its users to influence  the types of ads they see on Facebook. To find how to control the ads you see  on Facebook, please go&nbsp;<u><a href='https://www.facebook.com/help/146952742043748?helpref=related'>here</a></u>&nbsp;or adjust your ads settings  on&nbsp;<u><a href='https://www.facebook.com/ads/preferences/?entry_product=ad_settings_screen'>Facebook</a></u></p></li>
                            ...
                            <p>You may contact us at any time for details regarding this Privacy Policy  and its previous versions. For any questions concerning your account or your  personal data please contact us at contact@vensle.com.<br>
                              </p>
