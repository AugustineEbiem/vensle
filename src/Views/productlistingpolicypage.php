...
<div class='' id='services'> 
    <div class='page'>
      <div class='page-header'>
        <h1 class='page-title'>Product Listing Policy</h1>
      </div>
                        ...
                        <div class='panel-collapse collapse show' id='answer-5' aria-labelledby='question-5' role='tabpanel'>
						  ...
						  <ol>
                            <li><strong> GENERAL PROHIBITIONS:</strong></li>
                              ...
                              <p>1.3 Vensle.com, in its sole and exclusive discretion, reserves the right to  impose additional 
							...
							<li><strong> GOVERNMENT IDS, LICENSES AND UNIFORMS</strong></li>
                              ...
                              <li>Articles of clothing or identification that claim to be, or appear similar  to, official government uniforms.</li></ul></p>
							...
							<li><strong>  REPLICA AND COUNTERFEIT ITEMS</strong></li>
                              <p>29.1 Listing of counterfeits, non-licensed replicas, or unauthorized items,  such as counterfeit designer garment, watches, handbags, sunglasses, or other  accessories, is strictly prohibited on the Site.<br>
                              <p>29.2 If the products sold bear the name or logo of a company, but did not originate  from or were not endorsed by that company, such products are prohibited from  the Site.<br>
